...
namespace ThirdPartyInsurance.Controllers
{
    public class AppUsersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,LastName,DateOfBirth,Email,PhoneNumber")] AppUser appUser)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,LastName,DateOfBirth,Email,PhoneNumber")] AppUser appUser)
        {
            if (id != appUser.Id)
            {
                return NotFound();
